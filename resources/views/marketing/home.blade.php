    ...
    <div class="container comparison-inner">
      ...
      <div class="comparison-right">
        ...
        <ul class="audience-list">
          ...
          <li>
            <span class="icon-circle small"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg></span>
            <span><strong>Professionals</strong><small>Meeting notes, plans, presentations</small></span>
          </li>
        </ul>
      </div>
    </div>
